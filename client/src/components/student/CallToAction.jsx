...
const CallToAction = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>Whether you are a learner seeking to enhance your skills or an instructor wishing to share your knowledge, we are the ideal platform for you.</p>
