...
const CallToAction = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>Dù bạn là học viên muốn nâng cao kỹ năng hay là giảng viên mong muốn chia sẻ tri thức, Chúng tôi luôn là nền tảng lý tưởng dành cho bạn</p>
