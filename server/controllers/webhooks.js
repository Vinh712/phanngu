...
export const clerkWebhooks = async (req, res) => {
  try {
    ...
    // 🚩 Lúc này do dùng express.raw, req.body là Buffer
    const payload = req.body; // KHÔNG dùng JSON.stringify
    ...
    const { data, type } = evt; // lấy từ evt, không lấy từ req.body nữa
